...
#define BG_CBB(n)		n << 2
#define BG_SBB(n)		n << 8
#define BG_REG_32x32	0x0

// some sprite defines	
#define OBJ_ATTR(N, a)	(*(volatile u16*) (OAM_MEM_START + 8*N + 2*a))

#define ATTR0_Y(n)		(n & 0x00FF)	// -128~127
...
#define ATTR1_X(n)		(n & 0x01FF)	// -256~255
#define ATTR1_AID(n)	(n << 9)		// 0~31 affine matrix index
#define ATTR1_HFLIP		0x1000
#define ATTR1_VFLIP		0x2000
#define ATTR1_SIZE(n)	(n << 14)		// 0~3
#define ATTR1_SIZE0		0x0000
#define ATTR1_SIZE1		0x4000
#define ATTR1_SIZE2		0x8000
#define ATTR1_SIZE3		0xC000

#define ATTR2_ID(n)		(n & 0x03FF)	// tile index 0~1023
#define ATTR2_PRIO0		0x0000			// top		menus
#define ATTR2_PRIO1		0x0400			// 			frogs in front of fairy
#define ATTR2_PRIO2		0x0800			// 			fairy, frogs behind fairy
#define ATTR2_PRIO3		0x0C00			// bottom	shadows
...
#define INPUT_ACTIVE(n)				(INPUT & n ? 1 : 0)
#define CHARBLOCK(n)				((u16*) (0x6000000 + n*0x4000))		// Bg tile image data
#define SCREENBLOCK(n)				((u16*) (0x6000000 + n*0x0800))		// Bg construction data
#define spriteData              	((u16*) 0x6010000)
#define spritePal               	((u16*) 0x5000200)
#define bgPal						((u16*) 0x5000000)
#define REG_INT                 	(*(u32*)0x3007FFC)
#endif
